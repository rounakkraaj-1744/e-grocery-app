        ...
        <div className="grid gap-8 md:grid-cols-2 items-center">
          <div className="flex justify-center">
            ...
            >
              ...
              <motion.div
                className="absolute -left-5 bottom-20 w-12 h-12 bg-secondary/20 rounded-full z-0"
                animate={{
                  y: [0, -10, 0],
                  scale: [1, 1.2, 1],
                  opacity: [0.3, 0.6, 0.3],
          ...
          >
            ...
            <div className="flex items-center gap-2 p-3 bg-primary/5 rounded-lg border border-primary/10">
              ...
              <div className="text-sm">
                <p className="font-medium">Exclusive App Features</p>
                <p className="text-muted-foreground">Order tracking, exclusive offers, and faster checkout</p>
              </div>
            </div>
          </motion.div>
        </div>
