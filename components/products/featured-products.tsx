...
import { Star, ShoppingCart, Heart, Eye, Plus, Check, Award, Clock, Leaf } from 'lucide-react'
      ...
      <Tabs defaultValue="all" value={activeTab} onValueChange={setActiveTab} className="w-full">
        <div className="flex items-center justify-between">
          <TabsList className="bg-muted/50">
            ...
            <TabsTrigger value="fruits" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
              Fruits
            </TabsTrigger>
            <TabsTrigger value="vegetables" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
              Vegetables
            </TabsTrigger>
            <TabsTrigger value="dairy" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
              Dairy
            </TabsTrigger>
            <TabsTrigger value="bakery" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
              Bakery
            </TabsTrigger>
            <TabsTrigger value="meat" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
              Meat
            </TabsTrigger>
          </TabsList>
        </div>
...
function ProductCard({ product, isWishlisted, isInCart, onWishlistToggle, onAddToCart }: ProductCardProps) {
  ...
  return (
    ...
    >
      <Card 
        className="overflow-hidden border-border/50 transition-all duration-300 hover:border-primary/30 hover:shadow-lg"
