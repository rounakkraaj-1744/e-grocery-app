          ...
          <div className="absolute inset-0 flex items-center">
            <div className="w-full px-6 md:px-12 lg:w-2/3">
              <motion.div
                ...
                className="space-y-4"
              >
                <Badge className="bg-white text-foreground">{promo.badge}</Badge>
                <h2 className="text-2xl font-bold text-white md:text-4xl">{promo.title}</h2>
                <p className="text-white/90 md:text-lg">{promo.description}</p>
